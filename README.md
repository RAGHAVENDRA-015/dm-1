...
Navigating WEKA Explorer Panels Preprocess Panel
...
o	Header: Defines the dataset’s name (@relation) and lists attributes with their
data types (@attribute).

o	Data: Contains the actual data instances starting after the @data tag.
...
o	Click Open file in the Preprocess panel.
o	Navigate to the data folder within the WEKA installation directory.
o	Select a dataset like iris.arff or weather.arff.
...
Loading and Exploring Datasets in WEKA Datasets Used
•	Iris dataset
